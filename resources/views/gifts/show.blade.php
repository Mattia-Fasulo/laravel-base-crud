...
<section class="container py-5" id="single_gift">
    ...
    <div class="btn-section">
        <form action="{{route('gifts.destroy', ['gift'=>$gift->id])}}" method="POST">
            @csrf
            @method('DELETE')
            <!-- <button type="button" class="del" id="delete-button">delete</button> -->
            <button type="button" class="del" data-bs-toggle="modal"
        ...
        <button type="submit" class="edit"><a href="{{route('gifts.edit', ['gift'=>$gift->id])}}">edit</a></button>
